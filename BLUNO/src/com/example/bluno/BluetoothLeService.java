			...
			synchronized(this)
			{
	        	...
	        	if(status == BluetoothGatt.GATT_SUCCESS)
	        	{
            		...
            		else
	            	{
	            		...
	            		{
	            			bluetoothGattCharacteristicHelper.mCharacteristic.setValue(bluetoothGattCharacteristicHelper.mCharacteristicValue.substring(0, MAX_CHARACTERISTIC_LENGTH));
...
//		            			System.out.println(mCharacteristicRingBuffer.size());
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        String writeCharacteristicString = new String(characteristic.getValue());
